...
2x50kg lieferte bei meinen Test die geringste Temperaturabweichung, die Unterschiede bei den Wägezellen (CZL601, Vechta E120A, Mavin NA1) sind gering.
 
Die 2x100kg haben ein höhere Abweichung und bei meinen Tests gab es da dann sehr deutlich "Ausreißer" bei den Wägezellen (CZL601, Vechta E120A). 
