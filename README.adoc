...
* ADC wanderte in die Waage. Kurze Kabel zu den Dehnmesstreifen sind wichtig für eine geringere Temperaturabhängigkeit.
...
image::308_adc_qwiic.png[ADC QWIIC Verbindung]
