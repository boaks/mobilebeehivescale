...
|Personen Wägezelle 4x 50kg (einfache Waagenausführung)
...
Der mechanische Aufbau kann sich stark unterscheiden. Für den Aufbau mit den einfachen Personenwaagen Sensoren kann man sich Sensorhalter mit einem 3D-Drucker und link:halterung_fuer_waegezellen.stl[Halterung für Wägezellen] erstellen. Der Halter passt für die Sensoren in der Bestellliste und auch für link:https://www.kern-sohn.com/shop/de/produkte/messinstrumente/CK-50-Y4/[Kern CK 50-Y4]. Die Sensoren werden durch den Abstandshalter etwas von der Siebdruckplatten weg gehalten, was die Erwärmung durch Sonne über diese Platten verringert. Die Seite des Abstandshalters mit der Lücke ist für das Kabel vom `Kern CK 50-Y4` Sensor.

Je nach Ausführung werden andere Wägezelle benötigt, auch in ganz anderer Bauart wie z.B. Plattform Wägezelle, link:https://www.tinkerforge.com/de/shop/load-cell-100kg-czl601.html[CZL601 100kg]. Mit solchen Plattform Wägezellen kann man entweder eine Standard-Plattform Aufbau nehmen, oder zwei solche Zelle für einen besonders robusten Aufbau nehmen. Man muss aber auf jeden Fall die maximale Belastung beachten, sonst gehen die Sensoren leicht kaputt (link:https://www.bosche.eu/media/pdf/03/f0/32/Hilfe-bei-der-Auswahl-von-Wa-gezellen-TIPP.pdf[Wägezellen Auswahl]).

Mein Fokus liegt auf der Elektronik, daher führe ich diese unterschiedlichen Bauarten hier nicht auf. Man findet diese aber leicht im Web.
